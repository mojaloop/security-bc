...
export class KeycloakAuthorizationRepo implements IAuthorizationRepository{
    private _keycloakSvcUrl: string;
    private _logger: ILogger;

    constructor(keycloakSvcUrl: string, logger: ILogger) {
