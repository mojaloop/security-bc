...
export const defaultDevApplications = [
	...
	{client_id: "transfers-bc-event-handler-svc", client_secret: "superServiceSecret", roles:["transfers-bc-event-handler-svc"]},
	{client_id: "transfers-bc-api-svc", client_secret: "superServiceSecret", roles:["transfers-bc-api-svc"]},
